...
function CreateInfoGameIDDialog() {
    ...
    # Create Dialog
    $global:InfoGameIDDialog = CreateDialog -Width 550 -Height 500 -Icon $Files.icon.gameID
    ...
    # Create Text Box
    $TextBox = CreateTextBox -X 40 -Y 50 -Width ($InfoGameIDDialog.Width - 100) -Height ($CloseButton.Top - 60) -ReadOnly -Multiline -AddTo $InfoGameIDDialog
