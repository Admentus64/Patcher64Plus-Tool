...
#==============================================================================================================================================================================================
function IsRevert([object]$Elem=$null) {
...
function StartJobLoop([string]$Name, [switch]$Output) {
    ...
    RunJobLoop -Name $Name
    Stop-Job   -Name $Name
    if ($Output) { $result = Receive-Job -Name $Name }
...
#==================================================================================================================================================================================================================================================================
function RunJobLoop([string]$Name) {
...
function HideNativeOptions() {
    ...
    foreach ($option in $Redux.NativeOptions) {
        $option.Visible = $option.Hidden = !$IsWiiVC
