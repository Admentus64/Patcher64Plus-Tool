...
function CreateOptions() {
    ...
    CreateOptionsDialog -Columns 3 -Height 450
...
function CreateTabRedux() {
    ...
    CreateReduxCheckBox -Name "RandomBattleTheme"      -Text "Random Battle Theme"     -Info "Modifies the way in which the Battle Themes are used from the standard Zelda 2 Redux. With this patch, instead of having the FDS Battle Theme play on East Hyrule, now the game will load either the Battle Themes at random in all encounters." -Credits "ShadowOne333 and his team"
