function ByteOptions() {
    ...
    if (IsChecked $Redux.Debug.RemoveCrouchStab)        { ChangeBytes -Offset "C117B4" -Values "10 00 00 0D" }
...
function CreateOptions() {
    ...
    CreateOptionsDialog -Columns 6 -Height 490 -NoLanguages
    ...
    CreateReduxCheckBox -All -Name "RemoveCrouchStab"      -Text "Remove Crouch Stab"                 -Info "The Crouch Stab move is removed"                                                                                -Credits "Nokaubure"
    CreateReduxCheckBox -All -Name "ResumeLastArea"        -Text "Resume From Last Area"              -Info "Resume playing from the area you last saved in" -Warning "Be careful of saving in Grottos"                      -Credits "Aegiker (Debug)"
    ...
    CreateReduxCheckBox -All -Name "NormalFile1"           -Text "Normal File 1"                      -Info "Remove the Debug Save Data from File 1`nAllowing to start a fresh game again"                                   -Credits "ChriisTiian"
    CreateReduxCheckBox -All -Name "MapSelect"             -Text "Map Select"                         -Info "Remove the debug Map Select feature"                                                                            -Credits "ChriisTiian"
    CreateReduxCheckBox -All -Name "ItemSelect"            -Text "Item Select"                        -Info "Remove the debug Item Select feature"                                                                           -Credits "ChriisTiian"
    CreateReduxCheckBox -All -Name "FreeMovement"          -Text "Free Movement"                      -Info "Remove the debug Free Movement feature"                                                                         -Credits "ChriisTiian"
    CreateReduxCheckBox -All -Name "DebugCamera"           -Text "Debug Camera"                       -Info "Remove the debug Camera feature"                                                                                -Credits "ChriisTiian"
    CreateReduxCheckBox -All -Name "RemoveWrongEquip"      -Text "Master Sword Equip"                 -Info "Remove the debug Wrong Master Sword Equip feature"                                                              -Credits "ChriisTiian"
    CreateReduxCheckBox -All -Name "RemoveWrongDisplay"    -Text "Master Sword Display"               -Info "Remove the debug Wrong Master Sword Display feature"                                                            -Credits "ChriisTiian"
    CreateReduxCheckBox -All -Name "RemoveWrongIcon"       -Text "Hover Boots Icon"                   -Info "Remove the debug Wrong Hover Boots Icon feature"                                                                -Credits "ChriisTiian"
    ...
    CreateReduxCheckBox -All -Name "BoomerangFix"          -Text "Boomerang Fix"                      -Info "Fix the gem color on the thrown boomerang"                                                                      -Credits "Aria"
    ...
    CreateReduxCheckBox -All -Name "HyruleGardenCrash"     -Text "Hyrule Garden Crash"       -Checked -Info "Fix all GPU Errors and crashes when accessing the Early Hyrule Garden Game debug map"                           -Credits "ChriisTiian"
    CreateReduxCheckBox -All -Name "ZoraFountainCrash"     -Text "Zora's Fountain Crash"     -Checked -Info "Fixes the crashes when loading cutscenes 01 and 02 through the Debug Map Select"                                -Credits "ChriisTiian"
    CreateReduxCheckBox -All -Name "KokiriForest"          -Text "Kokiri Forest"                      -Info "Reduces the time when loading cutscenes 04 and 05 through the Debug Map Select"                                 -Credits "ChriisTiian"



    CreateReduxGroup    -All -Tag  "DebugGlitch" -Text "Glitch Fixes"
    CreateReduxCheckBox -All -Name "WaterTempleKeyFlag"    -Text "Water Temple Key Flag"              -Info "Fix the small key bug during the Water Temple"                                                                  -Credits "GhostlyDark"
    CreateReduxCheckBox -All -Name "BottleDupe"            -Text "Bottle Dupe and Ocarina"            -Info "Fixes the Bottle Dupe Glitch and Ocarina Glitch"                                                                -Credits "ChriisTiian"
    CreateReduxCheckBox -All -Name "SwordlessEpona"        -Text "Swordless Epona"                    -Info "Fixes the Swordless Epona Glitch"                                                                               -Credits "ChriisTiian"
    CreateReduxCheckBox -All -Name "InfiniteSword"         -Text "Infinite Sword"                     -Info "Fixes the Infinite Sword Glitch"                                                                                -Credits "ChriisTiian"
