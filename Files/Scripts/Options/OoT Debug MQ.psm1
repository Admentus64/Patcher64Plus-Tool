...
function CreateOptions() {
    ...
    CreateOptionsDialog -Columns 6 -Height 490
    ...
    CreateReduxCheckBox -Name "RemoveCrouchStab"      -Text "Remove Crouch Stab"                 -Info "The Crouch Stab move is removed"                                                                                -Credits "Nokaubure"
