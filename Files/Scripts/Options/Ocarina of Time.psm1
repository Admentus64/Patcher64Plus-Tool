...
function ByteOptions() {
  ...
  # if (IsChecked $Redux.Fixes.ShieldBurningCrash)    { ChangeBytes -Offset "DB2732" -Values "0000"                                                      }
    ...
    if ( (IsChecked $Redux.Hero.MiniBosses) -or (IsChecked $Redux.Hero.IronKnuckle)   )   { ChangeBytes -Offset @("E2B1E1", "E2B529", "E2B7A1", "E2B6A5", "E2BBE5", "E2BF25") -Values "FF"; ChangeBytes -Offset "E2B74A" -Values "40B0"; ChangeBytes -Offset "E2B7A6" -Values "0900"; ChangeBytes -Offset "E2B952" -Values "0001"; ChangeBytes -Offset @("E2BBFE", "E2BF3E") -Values "1500"; ChangeBytes -Offset @("E2BD86", "E2C00A") -Values "4100"; ChangeBytes -Offset "E2BE5A" -Values "03C2" }
    if ( (IsChecked $Redux.Hero.MiniBosses) -or (IsChecked $Redux.Hero.Peahat)        )   { ChangeBytes -Offset @("1BE120E", "1BE1216") -Values "4500"; ChangeBytes -Offset "1BE17AA" -Values "4000"; ChangeBytes -Offset @("1BE1804", "1BE19E4", "1BE1B44", "1BE2260", "1BE2D7C", "1BE2FF4") -Values "00"; ChangeBytes -Offset "1BE22AA" -Values "0500"; ChangeBytes -Offset "1BE22BA" -Values "FB00"; ChangeBytes -Offset @("1BE21EA", "1BE21F2") -Values "4080"; ChangeBytes -Offset "1BE2282" -Values "0700" }
    if ( (IsChecked $Redux.Hero.Enemies)    -or (IsChecked $Redux.Hero.HandMaster)    )   { ChangeBytes -Offset @("1BC1CE2", "1C8A292", "1C8A2B2", "1C8B606", "1C8B672") -Values "0000"; ChangeBytes -Offset "1C8A212" -Values "4100"; ChangeBytes -Offset "1C8B8EA" -Values "44A0"; ChangeBytes -Offset "1C8B9EE" -Values "41A0"; ChangeBytes -Offset "1C8BD3E" -Values "000A" 							}
    ...
    if ( (IsChecked $Redux.Hero.MiniBosses) -or (IsChecked $Redux.Hero.Stalfos)       )   { ChangeBytes -Offset "1BA7A90" -Values "00000000"; ChangeBytes -Offset "1BAAF6A" -Values "D000" 																														}
    ...
    if ( (IsChecked $Redux.Hero.Enemies)    -or (IsChecked $Redux.Hero.ReDead)        )   { ChangeBytes -Offset @("1C8EA76", "1C8EF22") -Values "4326"; ChangeBytes -Offset "1C8EED2" -Values "4516"; ChangeBytes -Offset @("1C8EF76", "1C8FAA2") -Values "000B"; ChangeBytes -Offset "1C8EE76" -Values "02FA"; ChangeBytes -Offset @("1C8F6D3", "1C8F8CF") -Values "0A"; ChangeBytes -Offset "1C90B6C" -Values "3FECECED" 		}
    ...
    if ( (IsChecked $Redux.Hero.MiniBosses) -or (IsChecked $Redux.Hero.Lizalfos)      )   { ChangeBytes -Offset "1BEC6C8" -Values "00";       ChangeBytes -Offset @("C36B12", "C36B36") -Values "4000"; ChangeBytes -Offset   "C36E56"                                -Values "D000" 																			}
    ...
    if ( (IsChecked $Redux.Hero.Enemies)    -or (IsChecked $Redux.Hero.Guay)          )   { ChangeBytes -Offset "1ECCE66" -Values "0070"; ChangeBytes -Offset "1ECCE86" -Values "4120"; ChangeBytes -Offset "1ECD3AA" -Values "40F0"; ChangeBytes -Offset "1ECD6F6" -Values "4500" 																			}
    ...
    if ( (IsChecked $Redux.Hero.MiniBosses) -or (IsChecked $Redux.Hero.GerudoFighter) )   { ChangeBytes -Offset @("1E9B4D2", "1E9C5BE", "1E9C9AE") -Values "0000"; ChangeBytes -Offset "1E9C7C6" -Values "4200" 																											}
