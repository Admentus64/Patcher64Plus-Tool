...
function CreateTabGraphics() {
    ...
    CreateReduxComboBox -Name "HookReticle"      -Text "Hookshot Reticle"    -Items "Ocarina of Time" -FilePath ($Paths.shared + "\HUD\Hook Reticle")  -Ext "bin" -Default "Ocarina of Time" -Info "Set the style for the Hookshot reticle"                                                            -Credits "GoldenMariaNova"
