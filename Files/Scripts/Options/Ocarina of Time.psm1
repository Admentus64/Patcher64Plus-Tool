...
function CreateTabMain() {
    ...
    CreateReduxComboBox -Name "RemoveOwls"           -All                     -Text "Remove Owls"            -Info "Kaepora Gaebora the owl will no longer interrupt Link with tutorials" -Items @("Disabled", "Enabled", "Includes Lake Hylia") -Default 1 -TrueDefault 1                        -Credits "Admentus & GoldenMariaNova"
