...
function ByteTextOptions() {
    ...
    if (IsChecked $Redux.Graphics.GCScheme) {
        ...
        SetMessage -ID "302B"; SetMessage -ID "407F";           SetMessage -ID "4081"; SetMessage -ID "7004"; SetMessage -ID "0108"; SetMessage -ID "1004"; SetMessage -ID "1007"; SetMessage -ID "2035"; SetMessage -ID "2035"; SetMessage -ID "302B"; SetMessage -ID "407F"; SetMessage -ID "407F"; SetMessage -ID "7004"; SetMessage -ID "0108"; SetMessage -ID "1007"
...
function CreateTabRedux() {
    ...
    CreateReduxComboBox -Name "HUDLayout"         -Text "HUD Layout"                -Items @("Ocarina of Time", "Inverted A and B", "Majora's Mask", "Nintendo", "Modern", "GameCube (Original)", "GameCube (Modern)") -Info "Choose from seven different layouts to change the HUD"
