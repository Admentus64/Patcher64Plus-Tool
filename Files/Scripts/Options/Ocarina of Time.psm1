...
function ByteOptions() {
  ...
  # if (IsChecked $Redux.Fixes.ShieldBurningCrash)    { ChangeBytes -Offset "DB2732" -Values "0000"                                                      }
    ...
    if ( (IsChecked $Redux.Hero.MiniBosses) -or (IsChecked $Redux.Hero.IronKnuckle)   )   { ChangeBytes -Offset @("DE9B99", "DE9EE1", "DEA15D", "DEA061", "DEA5A1", "DEA8E1") -Values "FF"; ChangeBytes -Offset "DEA102" -Values "40B0"; ChangeBytes -Offset "DEA15A" -Values "0900"; ChangeBytes -Offset "DEA30A" -Values "0001"; ChangeBytes -Offset @("DEA5BA", "DEA8FA") -Values "1500"; ChangeBytes -Offset @("DEA742", "DEA9C6") -Values "4100"; ChangeBytes -Offset "DEA816" -Values "03C2" }
    if ( (IsChecked $Redux.Hero.MiniBosses) -or (IsChecked $Redux.Hero.Peahat)        )   { ChangeBytes -Offset @("C2FA26", "C2FA2E") -Values "4500"; ChangeBytes -Offset "C2FFCA" -Values "4000"; ChangeBytes -Offset @("C30030", "C30210", "C30368", "C30A7C", "C3159C", "C31818") -Values "00"; ChangeBytes -Offset "C30AC6" -Values "0500"; ChangeBytes -Offset "C30AD6" -Values "FB00"; ChangeBytes -Offset @("C30A06", "C30A0E") -Values "4080"; ChangeBytes -Offset "C30A9E" -Values "0700" }
    if ( (IsChecked $Redux.Hero.Enemies)    -or (IsChecked $Redux.Hero.HandMaster)    )   { ChangeBytes -Offset @("C0F32A", "CD2F6E", "CD2F8E", "CD42EE", "CD435A") -Values "0000"; ChangeBytes -Offset "CD2EEA" -Values "4100"; ChangeBytes -Offset "CD45D2" -Values "44A0"; ChangeBytes -Offset "CD46D6" -Values "41A0"; ChangeBytes -Offset "CD4A2A" -Values "000A" 									}
    ...
    if ( (IsChecked $Redux.Hero.Enemies)    -or (IsChecked $Redux.Hero.Keese)         )   { ChangeBytes -Offset "C13977" -Values "00"; ChangeBytes -Offset @("C13BF2", "C13BFA", "C13D6E") -Values "0000"; ChangeBytes -Offset "C13D5E" -Values "2000"; ChangeBytes -Offset "C13E0E" -Values "0070"; ChangeBytes -Offset "C14546" -Values "4500"; ChangeBytes -Offset @("C1471E", "C14732") -Values "4120"; ChangeBytes -Offset @("C14A16", "C14A1E") -Values "40F0" }
    ...
    if ( (IsChecked $Redux.Hero.MiniBosses) -or (IsChecked $Redux.Hero.Stalfos)       )   { ChangeBytes -Offset "BFB35C" -Values "00000000"; ChangeBytes -Offset "BFE866" -Values "D000" 																														}
    ...
    if ( (IsChecked $Redux.Hero.Enemies)    -or (IsChecked $Redux.Hero.ReDead)        )   { ChangeBytes -Offset @("CD7662", "CD7B0E") -Values "4326"; ChangeBytes -Offset "CD7ABE" -Values "4516"; ChangeBytes -Offset "CD7A62" -Values "02FA"; ChangeBytes -Offset @("CD7B62", "CD869E") -Values "000B"; ChangeBytes -Offset @("CD82CF", "CD84CB") -Values "0A"; ChangeBytes -Offset "CD973C" -Values "3FECECED" 			}
    ...
    if ( (IsChecked $Redux.Hero.MiniBosses) -or (IsChecked $Redux.Hero.Lizalfos)      )   { ChangeBytes -Offset "C34DC8" -Values "00";       ChangeBytes -Offset @("C36B12", "C36B36") -Values "4000"; ChangeBytes -Offset   "C36E56"                                -Values "D000" 																			}
    ...
    if ( (IsChecked $Redux.Hero.Enemies)    -or (IsChecked $Redux.Hero.Guay)          )   { ChangeBytes -Offset "EEE41E" -Values "0070"; ChangeBytes -Offset "EEE442" -Values "4120"; ChangeBytes -Offset "EEE972" -Values "40F0"; ChangeBytes -Offset "EEECBE" -Values "4500" 																			}
    ...
    if ( (IsChecked $Redux.Hero.MiniBosses) -or (IsChecked $Redux.Hero.DarkLink)      )   { ChangeBytes -Offset   "C5B2F3"           -Values "FF"                                                                                                                                                                                                                                                                                      }
    if ( (IsChecked $Redux.Hero.MiniBosses) -or (IsChecked $Redux.Hero.GerudoFighter) )   { ChangeBytes -Offset @("EBDC4A", "EBED42", "EBF136") -Values "0000"; ChangeBytes -Offset "EBEF4E" -Values "4200" 																											}
    ...
    if (IsDefault $Redux.Hitbox.Stick 		  -Not)   { ChangeBytes -Offset "B7E8C0" -Values (ConvertFloatToHex $Redux.Hitbox.Stick.Value) 		   }
...
function CreateTabDifficulty() {
    ...
    CreateReduxGroup    -Tag  "Hero"          -Text "Harder Enemies" -Lite
    ...
    CreateReduxCheckBox -Name "ReDead"        -Text "ReDead/Gibdo"   -Info "ReDeads/Gibdos chase the player more quickly and efficiently, while also draining health faster"                                                                                                                   -Credits "Anthrogi"
    ...
    CreateReduxCheckBox -Name "Keese" 	      -Text "Keese"          -Info "Keese attack faster and move further, as well as variations not losing their effect when impacting the player`nThey also won't falter from hitting the player either" 					       -Credits "Euler & Anthrogi"
    ...
    CreateReduxCheckBox -Name "Lizalfos"      -Text "Lizalfos/Dinolfos" -Info "Lizalfos/Dinolfos will attack faster and do not falter from having attacks blocked`nThey also attack when z-targeting another enemy"                                                                            -Credits "Nokaubure, Euler & Anthrogi"
    CreateReduxCheckBox -Name "Stalfos"       -Text "Stalfos"        -Info "Stalfos do not falter from having attacks blocked`nThey also attack when z-targeting another enemy"                                                                                                                -Credits "Nokaubure, BilonFullHDemon & Admentus"
    ...
    CreateReduxCheckBox -Name "GerudoFighter" -Text "Gerudo Fighter" -Info "Gerudo Fighters don't get distracted if player moves out of their sight and recovers from spin attacks instantly"                                                                                          -Base 4 -Credits "Euler & Anthrogi"
    CreateReduxCheckBox -Name "IronKnuckle"   -Text "Iron Knuckle"   -Info "Iron Knuckles are set to their phase 2 state and move faster along with attacking more efficiently"                                                                                                                -Credits "Admentus & Anthrogi"
