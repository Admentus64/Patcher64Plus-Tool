...
function ByteOptions() {
    ...
    <#if ( (IsChecked $Redux.Hide.Minimaps) -or (IsChecked $Redux.Interface.Hide) ) {
...
function CreateOptions() {
    ...
    if     (IsInterface -Beginner)      { CreateOptionsDialog -Columns 6 -Height 590 -Tabs @("Main", "Graphics", "Audio", "Difficulty") }
    ...
    elseif (IsInterface -Streamlined)   { CreateOptionsDialog -Columns 6 -Height 595 -Tabs @("Main", "Graphics", "Audio", "Difficulty", "Equipment 1", "Equipment 2", "Animations") }
