...
function CreateTabSkip() {
    ...
    CreateReduxCheckBox -Name "GameOverScreen" -All -Text "Skip Game-Over Screen" -Info "Skip the game-over screen shown when losing all lives"                                                                                              -Credits "Ported from SM64 ROM Manager"
    CreateReduxCheckBox -Name "PeachIntro"     -All -Text "Skip Peach Intro"      -Info "Skip the introduction cutscene sequence when starting a new save file"                                                                              -Credits "Ported from SM64 ROM Manager"

    CreateReduxGroup    -Tag  "Skip"           -All -Text "Skip In-Game"
    CreateReduxCheckBox -Name "StarMessages"   -All -Text "Skip Star Messages"    -Info "Skip the messages displayed after collecting specific numbers of stars"                                                                             -Credits "Ported from SM64 ROM Manager"
    CreateReduxCheckBox -Name "BoosDialogue"   -All -Text "Remove Boos Dialogue"  -Info "Removes the dialogue for defeating Boos or when the Big Boo appears"                                                                                -Credits "Ported from SM64 ROM Manager"
    CreateReduxCheckBox -Name "Lakitu"         -All -Text "Skip Lakitu"           -Info "Skip the lakitu intro before entering the castle for the first time"                                                                                -Credits "Ported from SM64 ROM Manager"
    CreateReduxCheckBox -Name "StageIntro"     -All -Text "Skip Stage Intro"      -Info "Skip any messages that show up when entering a stage"                                                                                               -Credits "Ported from SM64 ROM Manager"
