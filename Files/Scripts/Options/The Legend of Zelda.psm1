...
function CreateTabMain() {
    ...
    CreateReduxCheckBox -Name "LinksAwakeningGFX" -Text "Link's Awakening GFX"     -Info "Restyle the graphics to look like Link's Awakening from the GameBoy`nNot compatible with the Animated Tiles or NES GFX options" -Credits "ShadowOne333 and his team"
...
function CreateTabRedux() {
    ...
    CreateReduxGroup    -Tag  "Graphics"      -Text "Graphics"
    CreateReduxCheckBox -Name "AnimatedTiles" -Text "Animated Tiles" -Info "Animate the tile`nNot compatible with the Link's Awakening GFX or NES GFX options" -Credits "ShadowOne333 and his team" -Warning "Does not work on the Wii Virtual Console or less accurate NES emulators"
    ...
    CreateReduxCheckBox -Name "NESGFX"                -Text "NES GFX"          -Info "Revert back any GFX graphics changes that Redux adjusted, for the original experience`nNot compatible with the Link's Awakening GFX or Animated Tiles options" -Credits "ShadowOne333 and his team"
