...
function CreateSwordTrailColorOptions() {
    ...
    $buttons +=      CreateReduxButton   -Tag $Buttons.Count        -Text "Trail (Tip)"                                                                                                                                            -Info "Select the tip color you want for the sword trail"    -Credits "Ported from Rando"
    $buttons +=      CreateReduxButton   -Tag $Buttons.Count        -Text "Trail (Base)"                                                                                                                                              -Info "Select the base color you want for the sword trail"      -Credits "Ported from Rando"
