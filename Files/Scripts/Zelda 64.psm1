...
function CreateSwordTrailColorOptions() {
    ...
    $buttons +=      CreateReduxButton   -Tag $Buttons.Count        -Text "Trail (Start)"                                                                                                                                            -Info "Select the starting tip/base color you want for the sword trail"      -Credits "Ported from Rando"
    $buttons +=      CreateReduxButton   -Tag $Buttons.Count        -Text "Trail (End)"                                                                                                                                            -Info "Select the ending tip/base color you want for the sword trail"      -Credits "Ported from Rando"
