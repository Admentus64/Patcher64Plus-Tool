...
I can absolutely assure you that the code present in the .exe is nothing more than the exact code found in the .ps1 and .psm1 source code files included with the release. Nothing more is added, and nothing less is removed.
